 ...
 * {@link send_tweet_dm_fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link send_tweet_dm_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class send_tweet_dm_fragment extends Fragment {
    ...
    /**
     * Instantiates a new Send tweet dm fragment.
     */
    public send_tweet_dm_fragment() {
    }
     ...
     * @return A new instance of fragment send_tweet_dm_fragment.
     */
    public static send_tweet_dm_fragment newInstance(String param1, String param2) {
        send_tweet_dm_fragment fragment = new send_tweet_dm_fragment();
    ...
    private JSONObject createData(String actionId, String reactionId, String actionData, String userTag, String msgContent) {
        ...
        try {
            ...
            jsonReactionData.put("dest", userTag);
            jsonReactionData.put("msg", msgContent);
    ...
    /**
     * Do a POST Request to the server for the reaction: Tweet Direct Message
     * @param rootView
     * @param actionId
     * @param reactionId
     * @param actionData
    ...
    private void processRequest(View rootView, String actionId, String reactionId, String actionData) {
        ...
        String tag;
        String msg;
        msgContent = rootView.findViewById(R.id.editText_message);
        userTag = rootView.findViewById(R.id.recipientName);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_send_tweet_dm, container, false);
        Button btn = rootView.findViewById(R.id.finishBtn);
        progressBar = rootView.findViewById(R.id.progressBar_tweetDm);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (clickable == true) {
                    ...
                    SendTweetDmTask task = new SendTweetDmTask(rootView);
    ...
    private class SendTweetDmTask extends TimerTask {
        /**
         * The Position.
         */
        View rootView;
         ...
         */
        public SendTweetDmTask(View mRootView) {
            rootView = mRootView;
        }
        @Override
        public void run() {
